...
The theme comes with two default collections: `experiences` and `projects`.
Items from the `experiences` collection are automatically displayed on the home page.
